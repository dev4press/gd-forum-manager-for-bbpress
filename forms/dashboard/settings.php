<div class="d4p-group d4p-dashboard-card d4p-dashboard-card-settings d4p-dashboard-card-no-footer">
    ...
    <div class="d4p-group-inner">
        ...
        <hr/>
        <h4><?php esc_html_e( 'Content Editing', 'gd-forum-manager-for-bbpress' ); ?></h4>
		<?php echo _gdfar_display_option( 'forum' ); ?>
		<?php echo _gdfar_display_option( 'topic' ); ?>
        <hr/>
        <h4><?php esc_html_e( 'Display Controls', 'gd-forum-manager-for-bbpress' ); ?></h4>
		<?php echo _gdfar_display_option( 'small_screen_always_show' ); ?>
		<?php echo _gdfar_display_option( 'notices_under_fields' ); ?>
        <hr/>
        <h4><?php esc_html_e( 'Advanced Settings', 'gd-forum-manager-for-bbpress' ); ?></h4>
