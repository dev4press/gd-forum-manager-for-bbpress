<div class="gdfar-modal gdfar-modal-slide" id="gdfar-modal-edit" aria-hidden="true">
    <div class="gdfar-modal__overlay" tabindex="-1" data-micromodal-close>
        <div class="gdfar-modal__container" role="dialog" aria-modal="true" aria-labelledby="gdfar-modal-edit-title">
            <header class="gdfar-modal__header">
                <h2 class="gdfar-modal__title" id="gdfar-modal-edit-title"></h2>
            ...
            <main class="gdfar-modal__content" id="gdfar-modal-edit-content"></main>
            <footer class="gdfar-modal__footer">
                <button id="gdfar-modal-edit-submit" class="gdfar-modal__btn gdfar-modal__btn-primary"><?php _ex( 'Save', 'Edit Modal Dialog, Save Button', 'gd-forum-manager-for-bbpress' ) ?></button>
